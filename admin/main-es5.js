            ...
            switch (this.defaultSidebar) {
              ...
              case 'iconbar':
                if (this.innerWidth < 1170) {
                  this.options.sidebartype = 'mini-sidebar'; // document.querySelector(".logo-icon").classList.add('box');
                } else {
    ...
    function srcAppSharedServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ApiService = /*#__PURE__*/function () {
        ...
        _createClass(ApiService, [{
          ...
          key: "users",
          value: function users(params) {
            return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl, "users").concat(this.obj_to_query(params)));
          }
        }, {
          key: "obj_to_query",
          value: function obj_to_query(obj) {
            var parts = [];
