(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppAuthenticationLockChangepasswordComponentHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div class=\"auth-wrapper d-flex no-block justify-content-center align-items-center\" style=\"background:url(assets/images/big/auth-bg.jpg) no-repeat; background-size: cover\">\n    <div class=\"auth-box\">\n        <div>\n            <div class=\"logo\">\n                <span class=\"db\"><img alt=\"thumbnail\" class=\"\" width=\"100\" src=\"assets/images/logo-text.svg\"></span>\n            </div>\n            <!-- Form -->\n            <div class=\"row\">\n                <div class=\"col-12\">\n                    <form [formGroup]=\"changepassForm\" class=\"form-horizontal m-t-20\" >\n                        <div class=\"form-group row\">\n                            <div class=\"col-12\">\n                                <input class=\"form-control form-control-lg\" formControlName=\"oldPassword\" type=\"password\" required=\"\" placeholder=\"Old Password\">\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('oldPassword').hasError('required') && changepassForm.controls['oldPassword'].touched\">\n                                    *Old Password is required.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('oldPassword').hasError('minlength') &&\n                                    !changepassForm.get('oldPassword').hasError('required')\">\n                                     *Min 8 characters.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('oldPassword').hasError('maxlength') &&\n                                    !changepassForm.get('oldPassword').hasError('required')\">\n                                    *Maximum 16 characters long.\n                                </mat-error>\n                            </div>\n                        </div>\n                        <div class=\"form-group row\">\n                            <div class=\"col-12\">\n                                <input class=\"form-control form-control-lg\" formControlName=\"newPassword\" type=\"password\" required=\"\" placeholder=\"New Password\">\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('newPassword').hasError('required') && changepassForm.controls['newPassword'].touched\">\n                                    *New Password is required.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('newPassword').hasError('minlength') &&\n                                    !changepassForm.get('newPassword').hasError('required')\">\n                                     *Min 8 characters.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold  px-1 d-block\" *ngIf=\"changepassForm.get('newPassword').hasError('maxlength') &&\n                                    !changepassForm.get('newPassword').hasError('required')\">\n                                    *Maximum 16 characters long.\n                                </mat-error>\n                            </div>\n                        </div>\n                        <div class=\"form-group row\">\n                            <div class=\"col-12\">\n                                <input class=\"form-control form-control-lg\" type=\"password\" formControlName=\"retypepassword\" required=\"\" placeholder=\"Retype Password\">\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('retypepassword').hasError('required') && changepassForm.controls['retypepassword'].touched\">\n                                    *Retype Password is required.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('retypepassword').hasError('minlength') &&\n                                    !changepassForm.get('retypepassword').hasError('required')\">\n                                     *Min 8 characters.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('retypepassword').hasError('maxlength') &&\n                                    !changepassForm.get('retypepassword').hasError('required')\">\n                                    *Maximum 16 characters long.\n                                </mat-error>\n                                <mat-error class=\"text-danger font-weight-bold px-1 d-block\" *ngIf=\"changepassForm.get('retypepassword').hasError('passwordMismatch') &&\n                                    !changepassForm.get('retypepassword').hasError('required')\">\n                                    *Password mismatched\n                                </mat-error>\n                            </div>\n                        </div>\n                        <div class=\"form-group text-center\">\n                            <div class=\"col-xs-12 p-b-20\">\n                                <button class=\"btn btn-block btn-lg bg-white text-dark\"[disabled]=\"!changepassForm.valid\" (click)=\"changepass()\" type=\"submit\">Submit</button>\n                            </div>\n                            <div class=\"col-xs-12 text-center\">\n                                <a class=\"btn btn-block btn-lg btn-danger\" (click)=\"history.back()\">Cancel</a>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n";
      /***/
    },
      ...
      var Login2Component = /*#__PURE__*/function () {
        ...
        _createClass(Login2Component, [{
          ...
          value: function ForgotPassword() {
            ...
            console.log(this.forgotForm.value, 'Forgot email');
            var obj = {
