...
export class SalesComponent implements AfterViewInit {
  ...
  getDashboardData() {
    this.api.dashboard(this.type).subscribe((res: any) => {
  ...
  public barChartColors: Array<any> = [{ backgroundColor: "#36bea6" }];
  ...
  public barChartColors1: Array<any> = [{ backgroundColor: "#EC75F6" }];
  public barChartData1: any[] = [
    { data: [0, 0, 0, 0, 0, 0, 0], label: "Revenue" },
  ];
  public barChartLabels2: string[] = ["M", "T", "W", "T", "F", "S", "S"];
}
